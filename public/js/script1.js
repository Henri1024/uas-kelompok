...
function createCell(item) {
    ...
    img = $(`<img src="../image/motor/${item.foto[0]}" alt="foto ${item.merk + ' ' + item.tipe}" class="card-img-top product-img" />`);
    ...
    if (item.merk.toLowerCase() === 'harley davidson') {
        ...
        btn = $(` <a href="\./motor/${item.id}"><button tipe="button" class="btn btn-primary btn-rent">Detail</button> </a>`);
        cardbody.append(btn);
    } else {
